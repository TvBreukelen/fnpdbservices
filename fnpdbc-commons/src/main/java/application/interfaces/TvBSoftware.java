...
public enum TvBSoftware {
	...
	DBCONVERT("DBConvert", "8.0", "dbconvert", "dbconvert/files", "dbconvert/best_release.json"),
	FNPROG2PDA("FNProg2PDA", "10.3", "fnprog2pda", "fnprog2pda/files", "fnprog2pda/best_release.json");
