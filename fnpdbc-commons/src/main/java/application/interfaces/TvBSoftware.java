...
public enum TvBSoftware {
	...
	DBCONVERT("DBConvert", "8.2", "dbconvert", "dbconvert/files", "dbconvert/best_release.json"),
	FNPROG2PDA("FNProg2PDA", "10.5", "fnprog2pda", "fnprog2pda/files", "fnprog2pda/best_release.json");
