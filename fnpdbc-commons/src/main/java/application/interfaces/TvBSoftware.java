...
public enum TvBSoftware {
	...
	DBCONVERT("DBConvert", "8.5.1", "dbconvert", "dbconvert/files", "dbconvert/best_release.json"),
	FNPROG2PDA("FNProg2PDA", "10.7.1", "fnprog2pda", "fnprog2pda/files", "fnprog2pda/best_release.json");
