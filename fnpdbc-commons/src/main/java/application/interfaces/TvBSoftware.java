...
public enum TvBSoftware {
	...
	DBCONVERT("DBConvert", "6.9", "dbconvert", "dbconvert/files", "dbconvert/best_release.json"),
	FNPROG2PDA("FNProg2PDA", "9.4", "fnprog2pda", "fnprog2pda/files", "fnprog2pda/best_release.json");
