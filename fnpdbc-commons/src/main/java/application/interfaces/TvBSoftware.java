...
public enum TvBSoftware {
	...
	DBCONVERT("DBConvert", "6.3.1", "dbconvert", "dbconvert/files", "dbconvert/best_release.json"),
	FNPROG2PDA("FNProg2PDA", "8.8.1", "fnprog2pda", "fnprog2pda/files", "fnprog2pda/best_release.json");
	...
	private TvBSoftware(String name, String version, String support, String download, String releaseInfo) {
		this.name = name;
